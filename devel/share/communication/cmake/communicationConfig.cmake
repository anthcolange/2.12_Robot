...
if("TRUE" STREQUAL "TRUE")
  set(communication_SOURCE_PREFIX /home/anthony/full_robot/src/communication)
  set(communication_DEVEL_PREFIX /home/anthony/full_robot/devel)
  ...
  set(communication_INSTALL_PREFIX /home/anthony/full_robot/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'anthony <anthony@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anthony/full_robot/src/communication/${idir}'.  Ask the maintainer 'anthony <anthony@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/anthony/full_robot/devel/lib;/home/anthony/full_robot/devel/lib;/home/anthony/ws_XRL/devel/lib;/opt/ros/indigo/lib)
